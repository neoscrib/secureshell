...
namespace SSH.MathEC
{
    public class ECCurve
    {
        ...
        public static ECCurve curve25519 { get; private set; }
        public static ECCurve secp160r1 { get; private set; }
        public static ECCurve secp256r1 { get; private set; }
        public static ECCurve secp384r1 { get; private set; }
        public static ECCurve secp521r1 { get; private set; }
        public static ECCurve test { get; private set; }

        static ECCurve()
        {
            curve25519 = new ECCurve()
            {
                Size = 256,
                p = BigInteger.Zero.AddUnsignedBigEndian(new byte[]
                {
                ...
                a = BigInteger.Zero.AddUnsignedBigEndian(new byte[]
                {
                ...
                b = BigInteger.Zero.AddUnsignedBigEndian(new byte[]
                {
                ...
                n = BigInteger.Zero.AddUnsignedBigEndian(new byte[]
                {
            ...
            curve25519.G = new ECPoint(
                BigInteger.Zero.AddUnsignedBigEndian(new byte[]
                {
                    0x2a, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
                    0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
                    0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
            ...
            secp160r1 = new ECCurve()
            {
                ...
                b = BigInteger.Zero.AddUnsignedBigEndian(new byte[] { 
                    ...
                    0xC5, 0x65, 0xFA, 0x45 }),
                S = BigInteger.Zero.AddUnsignedBigEndian(new byte[] { 
